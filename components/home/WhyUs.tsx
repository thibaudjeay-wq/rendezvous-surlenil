...
const args = [
  {
    ...
    description:
      'Sophie Godineau a une connaissance intime du terrain égyptien. Nasser Awadalla y est né. Ensemble, ils vous ouvrent les portes inaccessibles aux circuits classiques : temples peu connus, bateliers de confiance, guides soigneusement choisis.',
  },
  {
    icon: Languages,
