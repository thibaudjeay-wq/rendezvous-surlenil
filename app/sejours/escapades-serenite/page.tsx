      ...
      <section className="relative py-24 md:py-36 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="mailto:sophie@rendezvous-surlenil.com?subject=Escapade%20Sérénité" className="btn btn-secondary" style={{ color: 'white', borderColor: 'rgba(255,255,255,0.3)' }}>
              Écrire par email →
            </a>
          </div>
