...
const destinations = [
  {
    ...
    pricingNote: 'Tickets d\'entrée, repas, pourboires non inclus',
  ...
  },
  {
    ...
    options: [
      { label: 'La Bibliotheca Alexandrina' },
      { label: 'Les catacombes de Kom el-Choqafa' },
      { label: 'Le pilier de Pompée, le Sérapaeum, la citadelle de Qaitbay' },
    ],
    pricing: 'À partir de 90 € par personne / jour',
    pricingNote: 'Tickets d\'entrée, repas, pourboires non inclus',
      ...
      <section className="relative py-24 md:py-36 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto px-6">
          ...
          <ContactCTA
            ...
            whatsappUrl={whatsappUrlDefault}
            emailSubject="Escapade Sérénité"
          />
