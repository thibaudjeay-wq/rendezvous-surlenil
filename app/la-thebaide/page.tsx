          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  href="mailto:sophie@rendezvous-surlenil.com?subject=Réservation%20La%20Thébaïde"
      ...
      <section className="relative py-24 md:py-36 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:sophie@rendezvous-surlenil.com?subject=Disponibilité%20La%20Thébaïde"
              className="btn btn-secondary"
              style={{ color: 'white', borderColor: 'rgba(255,255,255,0.3)' }}
            >
              Écrire par email →
