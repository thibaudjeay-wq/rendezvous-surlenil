...
const STATIC_ARTICLES: Record<string, Post> = {
  ...
  'qu-est-ce-qu-une-dahabiya': {
    ...
    body: [
      ...
      block('p2', 'normal', "La différence tient à l'intimité. Sur un grand bateau de croisière, vous partagez le pont, la salle à manger, le guide et les escales avec 80 à 200 autres voyageurs. Sur une dahabiya, vous naviguez avec un groupe restreint dans une atmosphère intimiste. La privatisation complète est possible, mais c'est surtout la taille humaine du bateau qui change tout."),
