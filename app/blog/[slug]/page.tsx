...
const STATIC_ARTICLES: Record<string, Post> = {
  'quand-partir-en-egypte': {
    ...
    body: [
      ...
      block('p8', 'normal', "Septembre est notre mois préféré pour les voyageurs qui nous font confiance. La chaleur commence à refluer. La rentrée touristique n'a pas encore eu lieu. L'Égypte est dans un entre-deux rare : détendue, accessible, lumineuse. Les températures passent sous les 37°C en fin de mois. La Vallée des Rois retrouve un peu de silence."),
  ...
  'dormir-desert-blanc-egypte': {
    ...
    excerpt: "À quelques heures de Bahariya, le désert blanc est l'un des paysages les plus irréels d'Afrique. Des formations calcaires sculptées par le vent, une nuit sous les étoiles, un silence total : voici comment préparer cette expérience.",
    publishedAt: '2024-12-03',
    categories: [{ title: 'Expériences', slug: { current: 'experiences' } }],
    tags: ['désert', 'Bahariya', 'nuit étoiles', 'bivouac', 'désert blanc'],
    body: [
      block('p1', 'normal', "Il y a des paysages qui déjouent toute attente. Le désert blanc, accessible depuis l'oasis de Bahariya dans le Sahara occidental, en fait partie. Ce n'est pas le désert de sable que l'on imagine en Égypte, c'est un plateau de formations calcaires érodées par le vent, blanches comme de la craie, qui surgissent du sol sous des formes impossibles : champignons géants, personnages figés, animaux fantastiques."),
      ...
      block('p2', 'normal', "Le désert blanc ne se rejoint pas seul, du moins pas raisonnablement. L'approche classique : organiser le circuit depuis Bahariya, l'oasis logistique de référence, à 370 km du Caire (environ 4h30 de route). Farafra, bien que plus proche géographiquement du désert blanc, est une oasis très peu peuplée et peu équipée pour les excursions."),
      block('p3', 'normal', "Depuis Louxor, la logistique est plus complexe mais faisable : vol intérieur ou train vers le Caire, puis route jusqu'à Bahariya. Une nuit dans le désert blanc s'intègre idéalement dans un circuit de 3 à 4 jours dans les oasis du désert occidental, avant de rejoindre Louxor ou Assouan."),
      ...
      block('p5', 'normal', "La nuit est la vraie révélation. Sans pollution lumineuse à des centaines de kilomètres, le ciel du Sahara est d'une densité d'étoiles qui coupe le souffle. Voie lactée visible à l'œil nu, silence absolu (aucun insecte, aucun vent en hiver), températures fraîches."),
  ...
  'voyage-sur-mesure-egypte': {
    ...
    body: [
      ...
      block('p3', 'normal', "Le sur mesure n'est pas un service, c'est une relation. Cela commence par une conversation où vous parlez de vos voyages précédents, de ce qui vous a déçu, de ce qui vous a touché. Pas de catégories prédéfinies. Une vraie écoute."),
  ...
  'qu-est-ce-qu-une-dahabiya': {
    ...
    excerpt: "Utilisé sur le Nil depuis l'Antiquité, ce voilier traditionnel a séduit Agatha Christie et les grands explorateurs du XIXe siècle. Aujourd'hui rénové, il offre l'expérience la plus intime du Nil.",
    publishedAt: '2024-10-20',
    categories: [{ title: 'Croisières', slug: { current: 'croisieres' } }],
    tags: ['dahabiya', 'Nil', 'croisière', 'Louxor'],
    body: [
      block('p1', 'normal', "La dahabiya est un voilier traditionnel à fond plat, utilisé sur le Nil depuis l'Antiquité. Son nom vient de l'arabe « dahab », l'or. Au XIXe siècle, les grandes dahabiyas transportaient les voyageurs fortunés qui remontaient le fleuve vers Louxor et Assouan. Agatha Christie en faisait partie. Flaubert aussi. Et quelques archéologues qui préféraient la navigation douce aux caravanes."),
      block('h2a', 'h2', "Dahabiya et croisière classique : quelle différence ?"),
      block('p2', 'normal', "La différence tient à l'intimité. Sur un grand bateau de croisière, vous partagez le pont, la salle à manger, le guide et les escales avec 80 à 200 autres voyageurs. Sur une dahabiya, vous embarquez avec un groupe restreint dans une atmosphère intimiste, à bord d'un bateau à taille humaine. C'est cette échelle qui change tout."),
      ...
      block('p4', 'normal', "Les dahabiyas accueillent en général entre 8 et 12 cabines, soit jusqu'à 24 passagers. Les cabines sont climatisées, avec salle de bain privée. Un salon panoramique, une cuisine équipée, un pont terrasse pour les nuits étoilées. Le tout géré par un équipage de 10 à 14 personnes, capitaine, matelots, cuisinier. Un guide francophone vous accompagne pendant toute la croisière, pas seulement sur les sites."),
      ...
      block('p7', 'normal', "Si vous avez des questions sur la formule qui vous correspond le mieux, durée, budget, période, Sophie répond à toutes les questions. Un message suffit."),
    ],
  },
  ...
  'louxor-5-temples-meconnus': {
    ...
    body: [
      ...
      block('p8', 'normal', "Ce genre de détail, l'heure, l'entrée, l'angle, c'est exactement ce que Sophie apporte. Pas un guide téléphonique, mais une connaissance intime de ces lieux, construite depuis 2021 à Louxor."),
    ],
  },
  ...
  'siwa-oasis-secrete': {
    ...
    body: [
      block('p1', 'normal', "Siwa se mérite. Pour y arriver depuis Le Caire, il faut traverser 750 kilomètres de désert occidental, soit environ 9 heures de route. Les vols vers Marsa Matrouh sont rares et essentiellement réservés aux tours opérateurs. La plupart des voyageurs ne font pas cet effort. C'est exactement ce qui rend Siwa si précieux."),
      ...
      block('p3', 'normal', "Ce qu'on vient chercher à Siwa avant tout, c'est la baignade dans les lacs salés turquoise — trois fois plus salés que la Mer Morte, avec une flottabilité surprenante. Une expérience physique, presque irréelle, au milieu des palmiers et du désert."),
      block('p4', 'normal', "Et en second : une rupture avec le monde. Un temps suspendu, propice au silence, à la lenteur et à l'introspection. Siwa n'est pas un site à visiter. C'est un état d'esprit. Le temple d'Amon où Alexandre consulta l'oracle existe, et mérite le détour, mais ce n'est pas ce qui marque vraiment les voyageurs."),
      ...
      block('p6', 'normal', "Siwa s'intègre idéalement après un séjour au Caire ou à La Thébaïde. Ce n'est pas la combinaison la plus naturelle avec le désert blanc, qui se trouve beaucoup plus au sud. Comptez 3 à 5 nuits sur place pour vraiment décompresser. Sophie l'inclut régulièrement dans ses voyages sur mesure pour les voyageurs qui cherchent à s'éloigner radicalement des circuits touristiques."),
