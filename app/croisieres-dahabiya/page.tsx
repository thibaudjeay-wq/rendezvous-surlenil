        ...
        >
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href={whatsappMain} target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp">
            ...
            {formules.map((f) => (
              ...
              >
                ...
                <a
                  ...
                  className={`btn ${f.featured ? 'btn-whatsapp' : 'btn-whatsapp'} justify-center text-center`}
                >
                  Nous écrire →
                </a>
              </div>
